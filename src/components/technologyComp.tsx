  ...
  return (
    <>
      <div className="mt-48">
        ...
        <div className="h-fit px-30 bg-black">
          <div className="p-5 flex justify-between items-center pt-30">
            <h3 className="font-medium text-white text-5xl">
              Craft seamless, consumer-focused <br />
              experiences for users on any chain
            </h3>
            <button className="flex items-center px-5 py-4 gap-3 h-fit rounded-2xl text-white bg-[#C442D9] hover:bg-[#d52fef]">
              Read Whitepaper{" "}
          ...
          <div className="mt-30 flex flex-col items-center justify-center">
            ...
            <span className="text-white text-xl font-medium items-center text-center w-[60%] mt-20 pb-10">
